...
using namespace Voxel::NewUI;

Voxel::NewUI::UINode::UINode(const std::string& name)
	: pivot(glm::vec2(0))
	, name(name)
...
void Voxel::NewUI::UINode::updateMatrix()
{
...
void Voxel::NewUI::UINode::setParentPivot(const glm::vec2 & pivot)
{
	parentPivot = pivot;
}

glm::vec2 Voxel::NewUI::UINode::getParentPivot()
{
	return parentPivot;
}

bool Voxel::NewUI::UINode::getNextZOrder(ZOrder & curZOrder)
{
...
bool Voxel::NewUI::UINode::addChild(UINode * child)
{
...
bool Voxel::NewUI::UINode::addChild(UINode * child, int zOrder)
{
	return addChild(child, ZOrder(zOrder));
}

bool Voxel::NewUI::UINode::addChild(UINode * child, ZOrder& zOrder)
{
	if (child == nullptr) return false;
...
void Voxel::NewUI::UINode::setScale(const glm::vec2 & scale)
{
	this->scale = scale;
	updateMatrix();
}

void Voxel::NewUI::UINode::addScale(const glm::vec2 & scale)
{
	this->scale += scale;
	updateMatrix();
}

void Voxel::NewUI::UINode::setPosition(const glm::vec2 & position)
{
	this->position = position;
	updateMatrix();
}

void Voxel::NewUI::UINode::addPosition(const glm::vec2 & position)
{
	this->position += position;
	updateMatrix();
}

glm::vec2 Voxel::NewUI::UINode::getPosition()
{
	return position;
}

void Voxel::NewUI::UINode::setPivot(const glm::vec2 & pivot)
{
	this->pivot = pivot;
	updateMatrix();
}

void Voxel::NewUI::UINode::setVisibility(const bool visibility)
{
	visible = visibility;
}

bool Voxel::NewUI::UINode::isVisible()
{
	return visible;
}

void Voxel::NewUI::UINode::setSize(const glm::vec2 & size)
{
	this->size = size;
	this->updateMatrix();
}

glm::vec2 Voxel::NewUI::UINode::getSize()
{
	return size;
}

Voxel::Texture2D * Voxel::NewUI::UINode::getTexture()
{
	return nullptr;
}

void Voxel::NewUI::UINode::setColor(const glm::vec3 & color)
{
	this->color = color;
}

glm::vec3 Voxel::NewUI::UINode::getColor()
{
	return color;
}

void Voxel::NewUI::UINode::setOpacity(const float opacity)
{
...
float Voxel::NewUI::UINode::getOpacity()
{
	return opacity;
}

void Voxel::NewUI::UINode::setName(const std::string & name)
{
	if (!name.empty())
	{
		this->name = name;
...
std::string Voxel::NewUI::UINode::getName()
{
	return name;
}

glm::mat4 Voxel::NewUI::UINode::getModelMatrix()
{
	return modelMatrix;
}

Voxel::Geometry::Rect Voxel::NewUI::UINode::getBoundingBox()
{
...
bool Voxel::NewUI::UINode::hasChildren()
{
	return !children.empty();
}

bool Voxel::NewUI::UINode::isRenderable()
{
	return false;
}

unsigned int Voxel::NewUI::UINode::getIndicesOffset()
{
	return 0;
}

void Voxel::NewUI::UINode::getChildrenInVector(std::vector<UINode*>& nodes, UINode * parent)
{
	if (children.empty())
	{
		return;
...
void Voxel::NewUI::UINode::printChildren(const int depth)
{
	std::string str = "";
...
void Voxel::NewUI::UIBatch::load(const std::vector<float>& vertices, const std::vector<unsigned int>& indices, const std::vector<float>& colors, const std::vector<float>& uvs)
{
...
void Voxel::NewUI::UIBatch::render()
{
...
Voxel::NewUI::UITextBatch::UITextBatch()
	: vao(0)
	, vbo(0)
	, cbo(0)
	, uvbo(0)
...
void Voxel::NewUI::UITextBatch::load(const std::vector<float>& vertices, const std::vector<unsigned int>& indices, const std::vector<float>& colors, const std::vector<float>& uvs, const unsigned int maxTextLength)
{
...
void Voxel::NewUI::UITextBatch::update(const std::vector<float>& vertices, const std::vector<unsigned int>& indices, const std::vector<float>& colors, const std::vector<float>& uvs)
{
	glBindVertexArray(vao);
	glBindBuffer(GL_ARRAY_BUFFER, vbo);
	glBufferSubData(GL_ARRAY_BUFFER, 0, sizeof(float) * vertices.size(), &vertices.front());
...
void Voxel::NewUI::UITextBatch::render()
{
...
Voxel::NewUI::Image::Image(const std::string& name)
	: UINode(name)
	, texture(nullptr)
{}

bool Voxel::NewUI::Image::init(const std::string & textureName, const glm::vec2 & position, const glm::vec3 & color, const float opacity)
{
	// find texture
...
bool Voxel::NewUI::Image::initWithSpriteSheet(const ImageEntry* imageEntry, Texture2D * texture, const glm::vec2 & position, const glm::vec3 & color, const float opacity)
{
	if (texture)
	{
...
Image * Voxel::NewUI::Image::create(const std::string & name, const std::string & textureName, const glm::vec2 & position, const glm::vec3 & color, const float opacity)
{
...
Image * Voxel::NewUI::Image::createWithSpriteSheet(const std::string & name, const std::string & spriteSheetName, const std::string & imageName, const glm::vec2 & position, const glm::vec3 & color, const float opacity)
{
	if (name.empty()) return nullptr;
...
bool Voxel::NewUI::Image::buildVertices(std::vector<float>& bVertices, std::vector<unsigned int>& bIndices, std::vector<float>& bColors, std::vector<float>& bUVs, const unsigned int indexStart, const glm::mat4& parentMat)
{
...
bool Voxel::NewUI::Image::isRenderable()
{
	return visible;
}

unsigned int Voxel::NewUI::Image::getIndicesOffset()
{
	return 4;
}

Voxel::Texture2D* Voxel::NewUI::Image::getTexture()
{
	return this->texture;
}
...
Cursor * Voxel::NewUI::Cursor::create()
{
...
void Voxel::NewUI::Cursor::setPosition(const glm::vec2 & position)
{
	this->position = position;
...
void Voxel::NewUI::Cursor::addPosition(const glm::vec2 & distance)
{
...
void Voxel::NewUI::Cursor::updateBoudnary()
{
...
void Voxel::NewUI::Cursor::setCursorType(const CursorType cursorType)
{
	auto ss = SpriteSheetManager::getInstance().getSpriteSheet("CursorSpriteSheet");
...
void Voxel::NewUI::Cursor::setVisibility(const bool visibility)
{
	visible = visibility;
}

void Voxel::NewUI::Cursor::render()
{
	if (visible)
	{
		if (vao)
...
Voxel::NewUI::Text2::Text2(const std::string& name)
	: UINode(name)
	, text("")
	, align(ALIGN::LEFT)
	, maxTextLength(0)
...
Text2 * Voxel::NewUI::Text2::create(const std::string& name, const std::string& text, const glm::vec2& position, const glm::vec4& color, const int fontID, ALIGN align, const int maxLength)
{
...
Text2 * Voxel::NewUI::Text2::createWithOutline(const std::string& name, const std::string & text, const glm::vec2 & position, const int fontID, const glm::vec4 & color, const glm::vec3 & outlineColor, ALIGN align, const int maxLength)
{
	Text2* newText = new Text2(name);
	newText->font = FontManager::getInstance().getFont(fontID);
...
void Voxel::NewUI::Text2::setText(const std::string & text)
{
	if (!text.empty())
	{
		if (text != this->text)
...
std::string Voxel::NewUI::Text2::getText()
{
	return text;
}

bool Voxel::NewUI::Text2::isOutlined()
{
	return font->getOutlineSize() > 0;
}

void Voxel::NewUI::Text2::setColor(const glm::vec4 & color)
{
	this->color = color;
...
glm::vec4 Voxel::NewUI::Text2::getOutlineColor()
{
	return glm::vec4(outlineColor, opacity);
}

unsigned int Voxel::NewUI::Text2::getMaxTextLength()
{
	return maxTextLength;
}

void Voxel::NewUI::Text2::clear()
{
	text = "";
}

Voxel::NewUI::Text2::~Text2()
{
}

bool Voxel::NewUI::Text2::init(const std::string & text, const glm::vec2& position, const glm::vec4& color, ALIGN align, const int maxLength)
{
	this->text = text;
	this->align = align;
	this->color = color;
...
bool Voxel::NewUI::Text2::initWithOutline(const std::string & text, const glm::vec2 & position, const glm::vec4 & color, const glm::vec3 & outlineColor, ALIGN align, const int maxLength)
{
	this->text = text;
	this->align = align;
	this->color = color;
...
std::vector<glm::vec2> Voxel::NewUI::Text2::computeOrigins(Font * font, const std::vector<std::string>& split)
{
...
bool Voxel::NewUI::Text2::isRenderable()
{
	return visible && !text.empty();
}

int Voxel::NewUI::Text2::getOutlineSize()
{
	if (font)
	{
...
Voxel::Texture2D * Voxel::NewUI::Text2::getTexture()
{
	if (font)
	{
...
bool Voxel::NewUI::Text2::buildVertices(std::vector<float>& bVertices, std::vector<unsigned int>& bIndices, std::vector<float>& bColors, std::vector<float>& bUVs, const unsigned int indexStart, const glm::mat4 & parentMat)
{
	if (font)
	{
		if (text.empty())
...
Canvas * Voxel::NewUI::Canvas::create(const glm::vec2 & size, const glm::vec2 & position)
{
...
bool Voxel::NewUI::Canvas::getNextZOrder(ZOrder & curZOrder)
{
	bool lookForLocal = false;
	int globalTemp = std::numeric_limits<int>::min();
	int localTemp = globalTemp;
...
bool Voxel::NewUI::Canvas::addNode(UINode * node)
{
...
bool Voxel::NewUI::Canvas::addNode(UINode * node, int zOrder)
{
	return addNode(node, ZOrder(zOrder));
}

bool Voxel::NewUI::Canvas::addNode(UINode * node, ZOrder zOrder)
{
	if (node == nullptr) return false;
	...
	{
		if (dynamic_cast<NewUI::Image*>(node))
		{
...
glm::vec2 Voxel::NewUI::Canvas::getSize()
{
	return size;
}

void Voxel::NewUI::Canvas::setSize(const glm::vec2 & size)
{
...
bool Voxel::NewUI::Canvas::getVisibility()
{
	return visible;
}

void Voxel::NewUI::Canvas::setVisibility(const bool visibility)
{
	this->visible = visibility;
}

void Voxel::NewUI::Canvas::updateBatch()
{
	if (needToUpdateBatch)
	{
		...
		for (auto node : nodes)
		{
			if (auto textObj = dynamic_cast<NewUI::Text2*>(node))
			{
...
void Voxel::NewUI::Canvas::render()
{
	for (auto e : batches)
	{
		//e->render();
...
Text * Voxel::NewUI::Text::create(const std::string & text, const glm::vec2& position, const glm::vec4& color, const int fontID, ALIGN align, TYPE type, const int maxLength)
{
...
Text * Voxel::NewUI::Text::createWithOutline(const std::string & text, const glm::vec2 & position, const int fontID, const glm::vec4 & color, const glm::vec4 & outlineColor, ALIGN align, TYPE type, const int maxLength)
{
	Text* newText = new Text();
	newText->font = FontManager::getInstance().getFont(fontID);
...
void Voxel::NewUI::Text::setText(const std::string & text)
{
	if (!text.empty())
	{
		if (text != this->text)
...
std::string Voxel::NewUI::Text::getText()
{
	return text;
}

bool Voxel::NewUI::Text::isOutlined()
{
	return outlined;
}

void Voxel::NewUI::Text::setColor(const glm::vec4 & color)
{
	this->color = color;
...
glm::vec4 Voxel::NewUI::Text::getOutlineColor()
{
	return outlineColor;
}

void Voxel::NewUI::Text::clear()
{
	text = "";
}
...
bool Voxel::NewUI::Text::init(const std::string & text, const glm::vec2& position, const glm::vec4& color, ALIGN align, TYPE type, const int maxLength)
{
	this->text = text;
	this->align = align;
	this->color = color;
...
bool Voxel::NewUI::Text::initWithOutline(const std::string & text, const glm::vec2 & position, const glm::vec4 & color, const glm::vec4 & outlineColor, ALIGN align, TYPE type, const int maxLength)
{
	this->text = text;
	this->align = align;
	this->color = color;
...
bool Voxel::NewUI::Text::buildMesh(const bool update)
{
	if (font)
	{
...
void Voxel::NewUI::Text::loadBuffers(const std::vector<float>& vertices, const std::vector<float>& colors, const std::vector<float>& uvs, const std::vector<unsigned int>& indices)
{
	// based on data, load data for the first time
	glGenVertexArrays(1, &vao);
	glBindVertexArray(vao);
...
void Voxel::NewUI::Text::updateBuffer(const std::vector<float>& vertices, const std::vector<float>& colors, const std::vector<float>& uvs, const std::vector<unsigned int>& indices)
{
	if (type == TYPE::DYNAMIC)
	{
		glBindVertexArray(vao);
...
void Voxel::NewUI::Text::clearBuffer()
{
	if (type == TYPE::DYNAMIC)
	{
...
std::vector<glm::vec2> Voxel::NewUI::Text::computeOrigins(Font * font, const std::vector<std::string>& split)
{
	std::vector<glm::vec2> originList;
...
void Voxel::NewUI::Text::render(const glm::mat4& screenMat, const glm::mat4& canvasPivotMat, Program* prog)
{
	if (!visible) return;
	if (indicesSize == 0) return;
	if (!loaded) return;
